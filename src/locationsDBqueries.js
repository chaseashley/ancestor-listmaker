...
export async function updateCoordinates(locationName, coordinates) {
    const dbURL = 'https://ancestor-listmaker-backend.herokuapp.com/locations/update';
    return await axios.put(dbURL, {'locationName': locationName, 'coordinates': coordinates})
    .catch(function (error) {
        if (error.response) {
          // The request was made and the server responded with a status code
          // that falls out of the range of 2xx
