...
class Main extends React.Component {
  ...
  render() {
    ...
    if (this.state.processingStatus ==='Done') {
      if (this.state.lastAhnentafel) {
        displayedTable = <AhnenTable tableData={this.state.matchingAncestorsList} fullname={this.state.lastFullname} descendantJson={this.state.descendantJson} ancestorList={this.state.ancestorList}/>;
      } else {
        displayedTable = <Table tableData={this.state.matchingAncestorsList} fullname={this.state.lastFullname} descendantJson={this.state.descendantJson} ancestorList={this.state.ancestorList}/>;
      }  
    } else {
          ...
          <table className={styles.formTable}>
            <tbody>
              ...
              <tr>
                ...
                <td><input type="checkbox" name="ahnentafelCheckbox" checked={this.state.ahnentafel} onClick={(e) => this.setState({ahnentafel: e.target.checked})}/>
                    <label for="ahnentafelCheckbox">Include generation and ahnentafel number column</label></td>
                <td><input type="checkbox" name="fullnameCheckbox" checked={this.state.fullname} onClick={(e) => this.setState({fullname: e.target.checked})}/>
  ...
  componentWillUnmount() {
    sessionStorage.setItem('FLMainState', JSON.stringify(this.state));
  }
  
  componentDidMount() {
    const storedState = sessionStorage.getItem('FLMainState');
    if (storedState !== null) {
      const storageObject = JSON.parse(storedState);
      this.setState(storageObject);
      sessionStorage.removeItem('FLMainState');
    } else {
